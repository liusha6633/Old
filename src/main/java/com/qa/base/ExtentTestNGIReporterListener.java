...
public class ExtentTestNGIReporterListener implements IReporter {
    ...
    private static final String FILE_NAME = "index" + form +".html";
    ...
    private void init() {
        ...
        htmlReporter.config().setResourceCDN(ResourceCDN.EXTENTREPORTS);
        htmlReporter.config().setDocumentTitle("老钱包自动化测试报告");
        htmlReporter.config().setReportName("老钱包自动化测试报告");
...
//                test.pass(MarkupHelper.createCodeBlock(outputList, CodeLanguage.JSON));
